...
import { FruitItemsServiceServer } from "../services/fruitItems";
import { RecomendationItemsServiceServer } from "../services/recomendationItems";
...
@NgModule({
  ...
  providers: [
    StatusBar,
    SplashScreen,
    FruitItemsServiceServer,
    RecomendationItemsServiceServer,
